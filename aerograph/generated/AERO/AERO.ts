...
export class AERO__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class AERO extends ethereum.SmartContract {
  static bind(address: Address): AERO {
    return new AERO("AERO", address);
  }
  ...
  eip712Domain(): AERO__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new AERO__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<AERO__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      []
